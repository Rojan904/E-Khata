...
class ReceiveTransactPage extends StatefulWidget {
  const ReceiveTransactPage({Key? key}) : super(key: key);

  @override
  _ReceiveTransactPageState createState() => _ReceiveTransactPageState();
}

class _ReceiveTransactPageState extends State<ReceiveTransactPage> {
